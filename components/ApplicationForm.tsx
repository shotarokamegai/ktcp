...
const inputClass = cx(fieldBase, "pre:h-[40px] pre:px-[12px] pre:bg-beige");
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="slide-in">
      ...
      <Row
        ...
        required
        error={errors.job}
        className="pre:flex pre:items-center pre:pb-10 pre:mb-10 pre:border-b pre:border-solid pre:border-lightGray pre:flex-row"
        labelClassName="pre:mr-[60px]"
        withDivider={false}
      >
        <div className="pre:flex pre:flex-wrap pre:gap-[15px]">
          {JOB_OPTIONS.map((opt) => {
            ...
            return (
              <button
                ...
                className={cx(
                  "pre:rounded-[999px] pre:px-[20px] pre:h-[40px] pre:border pre:border-solid pre:border-lightGray",
                  "pre:text-[12px] pre:font-light pre:font-dnp pre:cursor-pointer",
      ...
      <div className="pre:mt-[100px] pre:mb-[24px]">
        ...
        <label className="pre:flex pre:items-center pre:justify-center pre:gap-[10px] pre:cursor-pointer">
          ...
          />
          <span className="pre:text-[16px] pre:font-bold pre:text-[#222]">
            プライバシーポリシーに同意します
          </span>
        </label>
      </div>
