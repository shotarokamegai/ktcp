      ...
      sections={[
        {
          ...
          ja: "イントロ",
          text:
            "フロントエンドエンジニアは、デザインやコンセプトをブラウザ上で体験として成立させるポジションです。<br/>ディレクターやデザイナーと連携しながら、画面設計やインタラクションの実装を通して、意図を正確に、そして魅力的に届けていきます。<br/><br/>単にコードを書くのではなく、「なぜこの表現なのか」「どうすれば伝わるか」を考えながら、表現と構造の両面から最適な形を探っていくことを大切にしています。<br/><br/>まずは実装業務から関わり、徐々に設計や表現の提案にも踏み込みながら、チームと一緒に魅せ方をつくっていくポジションです。",
        },
        {
          kind: "list",
          en: "Job Desc.",
