...
export const metadata: Metadata = {
  title: "Privacy policy | Ketchup Inc. | 株式会社 Ketchup",
  description: "プライバシーポリシーページ",
  openGraph: { title: "Privacy policy | Ketchup Inc. | 株式会社 Ketchup" },
};
  ...
  if (!page) {
    return (
      <main className="container pre:pt-[307px] slide-out">
        <section className="pre:w-[calc(100%-40px)] pre:text-center pre:pb-[185px]">
            <h1 className="pre:text-[24px] pre:font-gt pre:font-light slide-in pre:mb-[60px]">Privacy Policy</h1>
            <p className="pre:w-[530px] pre:mx-auto pre:font-normal slide-in">
              株式会社Ketchup（以下、「当社」といいます。）は、本ウェブサイトを通じてお問い合わせいただいたお客様および求職者の個人情報について、以下のとおりプライバシーポリシーを定めます。<br/><br/>
第1条（個人情報）「個人情報」とは、個人情報保護法における「個人情報」を指し、<br/>
氏名、生年月日、住所、電話番号、メールアドレス、勤務先、職歴、学歴その他の記述等により特定の個人を識別できる情報をいいます。<br/><br/>
